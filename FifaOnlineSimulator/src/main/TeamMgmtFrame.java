...
public class TeamMgmtFrame extends JFrame {
	...
	public TeamMgmtFrame() {
		...
		lblOvr.setFont(new Font("±¼¸²", Font.BOLD, 20));
		...
		lblPac.setFont(new Font("±¼¸²", Font.BOLD, 14));
		...
		lblSho.setFont(new Font("±¼¸²", Font.BOLD, 14));
		...
		lblDef.setFont(new Font("±¼¸²", Font.BOLD, 14));
		...
		lblPhy.setFont(new Font("±¼¸²", Font.BOLD, 14));
		...
		btnRelease.setFont(new Font("±¼¸²", Font.BOLD, 14));
